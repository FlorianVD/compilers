...
struct Visitor {
  ...
  public:
    ...
    RetTy visitEmptyStmt(EmptyStmt &node, ArgTys... args) { return RetTy(); }
    ...
    RetTy visitIntLiteral(IntLiteral &node, ArgTys... args) { return RetTy(); }
    ...
    RetTy visitVarRefExpr(VarRefExpr &node, ArgTys... args) { return RetTy(); }
    ...
    RetTy visitInlineAsmStmt(InlineAsmStmt &node, ArgTys... args) {
        return RetTy();
    }
    ...
    RetTy visit(Base &node, ArgTys... args) {
        ...
        case Base::Kind::InlineAsmStmt:
            return derived().visitInlineAsmStmt(
                static_cast<InlineAsmStmt &>(node), args...);
        default:
